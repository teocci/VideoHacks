...
import com.github.teocci.videohacks.content.ContentManager;
import com.android.videohacks.R;
import com.github.teocci.videohacks.utils.AboutBox;
...
public class MainActivity extends ListActivity
{
    ...
    private static final String[][] TESTS = {
            {"* Play video (TextureView)",
                    "Plays .mp4 videos created by Videohacks",
                    "PlayMovieActivity"},
            {"Continuous capture",
            ...
            {"Capture camera and send through UDP",
                    "Shows camera preview, records when requested",
                    "CameraCaptureUDPActivity"},
